...
const Footer: React.FC = () => {
  ...
  return (
    <footer ref={sectionRef} className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white mt-8 overflow-hidden">
      ...
      {/* Road strip with two trucks - Made Smaller */}
      <div className="relative h-16 overflow-visible mb-4 z-20">
        {/* Single lane solid line */}
        <div className="absolute inset-x-0 top-[30%] -translate-y-1/2 h-[2px] bg-gradient-to-r from-slate-600 via-slate-500 to-slate-600 shadow-lg"></div>
        {/* Single lane dashed line */}
        <div className="absolute inset-x-2 top-[30%] -translate-y-1/2 flex justify-between items-center">
        ...
        <div
          ref={leftTruckRef}
          className="pointer-events-none absolute left-[-60px] -top-[20%] z-10 flex items-center"
        >
          <Image
            ...
            width={80}
            height={40}
            className="drop-shadow-2xl w-12 h-6 filter brightness-110"
          />
        </div>
        {/* Big truck goes left - in front and moved up */}
        <div
          ref={rightTruckRef}
          className="pointer-events-none absolute right-[-60px] top-[15%] z-30 flex items-center"
        >
          <Image
            ...
            width={80}
            height={60}
            className="drop-shadow-2xl w-12 h-8 filter brightness-110"
          />
        </div>
      </div>
