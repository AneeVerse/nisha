              ...
              <div className="max-w-2xl">
                ...
                <div className="mt-6 space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center bg-gradient-to-r from-[#2489be]/10 via-[#89517f]/10 to-[#cb4147]/10 text-[#2489be] mt-0.5">
                  ...
                  {/* Dedicated Team */}
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center bg-gradient-to-r from-[#2489be]/10 via-[#89517f]/10 to-[#cb4147]/10 text-[#89517f] mt-0.5">
                      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center bg-gradient-to-r from-[#2489be]/10 via-[#89517f]/10 to-[#cb4147]/10 text-[#cb4147] mt-0.5">
                      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="relative aspect-[4/5] overflow-hidden">
                      ...
                      <div className="absolute bottom-4 sm:bottom-5 md:bottom-6 right-4 sm:right-5 md:right-6 z-10">
                        <div className="relative group">
                          <span className="absolute -inset-2 sm:-inset-3 rounded-full bg-gradient-to-r from-[#2489be] via-[#89517f] to-[#cb4147] opacity-60 blur-lg animate-pulse group-hover:opacity-80" />
                          <button
                            onClick={handlePlayVideo}
                            className="relative w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center bg-black ring-2 ring-[#2489be] text-[#2489be] shadow-xl transition-all duration-200 hover:bg-gradient-to-r hover:from-[#2489be] hover:via-[#89517f] hover:to-[#cb4147] hover:text-white hover:ring-[#2489be] hover:scale-110"
