  ...
  return (
    <section id="our-solution" className="mx-auto max-w-[1500px] px-4 sm:px-6 md:px-10 lg:px-12 py-12 sm:py-16 md:py-20 mt-20">
      ...
      <div className="flex items-center justify-center gap-2 sm:gap-3 font-medium">
        <span className="h-2.5 w-2.5 sm:h-3 sm:w-3 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 inline-block" />
        <span className="text-gray-600 font-normal text-sm sm:text-base">OUR SERVICES</span>
      </div>
      ...
      <h2 className="mt-4 sm:mt-5 text-center text-2xl sm:text-3xl md:text-4xl lg:text-[42px] xl:text-[48px] font-extrabold leading-tight tracking-tighter">
        ...
        <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-pink-500">Effortless Global Shipping</span>
      </h2>
        ...
        <div className="block sm:hidden" ref={dropdownRef}>
          <div className="relative">
            ...
            <button
              ...
              className="w-full flex items-center justify-between bg-white border-2 border-gray-100 rounded-2xl px-5 py-4 shadow-sm hover:shadow-md transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
            >
                ...
                <div className="py-2">
                  {PRIMARY_SERVICES.map((service) => (
                    <button
                      ...
                      className={`w-full text-left px-5 py-3 hover:bg-purple-50 transition-colors duration-150 ${
                        active === service.key ? 'bg-purple-50 border-r-4 border-purple-500' : ''
                      }`}
                    >
                      <div className="flex items-center gap-3">
                        <div className={`h-2.5 w-2.5 rounded-full ${
                          active === service.key ? 'bg-gradient-to-r from-purple-500 to-pink-500' : 'bg-gray-300'
                        }`}></div>
                        <span className={`text-sm font-medium ${
                          active === service.key ? 'text-purple-600' : 'text-gray-700'
                        }`}>
                          {service.label}
                        </span>
                      </div>
      ...
      <div className="mt-6 sm:mt-8 mx-auto max-w-[1100px] rounded-[24px] overflow-hidden bg-gradient-to-r from-purple-600 to-pink-500 shadow-lg">
            ...
            <div className="flex flex-col justify-center text-white px-1 md:px-2 lg:px-1">
              ...
              <div className="mt-5 sm:mt-6">
                <button
                  ...
                  className="group inline-flex items-center rounded-full bg-white text-purple-700 pl-5 pr-2 py-2.5 text-sm font-medium shadow-sm transition-colors hover:bg-white/90"
                >
                  <span>Get a Free Quote</span>
                  <span className="ml-3 inline-flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-r from-purple-500 to-pink-500 text-white">
                    <svg
